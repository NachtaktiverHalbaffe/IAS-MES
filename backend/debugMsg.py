...
msg=     ""
msgOrg = ""
        
sh = ServiceOrderHandler()
sh.decodeMessage(msg)
sh._printAttr()
print("Original")
print("")
sh2 = ServiceOrderHandler()
sh2.decodeMessage(msgOrg)
sh2._printAttr()
