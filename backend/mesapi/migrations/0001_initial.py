    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partNo', models.PositiveIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignedToOrder', models.ManyToManyField(to='mesapi.AssignedOrder')),
            ],
        ),
        migrations.CreateModel(
            name='WorkingStep',
            fields=[
                ('name', models.CharField(max_length=30)),
                ('description', models.CharField(default='', max_length=200)),
                ('task', models.CharField(choices=[('assemble', 'Assemble the workingpiece'), ('package', 'Package the workingpiece'), ('unpackage', 'Unpackage the workingpiece'), ('color', 'Paint the workingpiece'), ('generic', 'Own implementation of a task')], default='assemble', max_length=15)),
                ('assignedToUnit', models.PositiveIntegerField()),
                ('color', colorfield.fields.ColorField(default='#000000', max_length=18)),
                ('stepNo', models.PositiveSmallIntegerField(primary_key=True, serialize=False)),
                ('operationNo', models.PositiveSmallIntegerField(default=510)),
                ('workingPlan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mesapi.workingplan')),
            ],
        ),
        migrations.CreateModel(
            name='VisualisationTask',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('task', models.CharField(choices=[('assemble', 'Assemble the workingpiece'), ('package', 'Package the workingpiece'), ('unpackage', 'Unpackage the workingpiece'), ('color', 'Paint the workingpiece'), ('generic', 'Own implementation of a task')], default='assemble', max_length=15)),
                ('assignedUnit', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='mesapi.statevisualisationunit')),
                ('assignedWorkingPiece', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mesapi.stateworkingpiece')),
            ],
        ),
    ]
