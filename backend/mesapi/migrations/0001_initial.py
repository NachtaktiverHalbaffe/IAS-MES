# Generated by Django 3.2.3 on 2021-06-23 08:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operationNo', models.PositiveSmallIntegerField(choices=[(510, 'Manual work'), (213, 'release a defined part on stopper 2'), (210, 'store a part from stopper 1'), (1110, 'delay')], default=510)),
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
            ],
            options={
                'ordering': ['stepNo'],
